...
<button id="sidebar-toggle" class="text-gray-700 hover:text-green-600">
...
<!-- Sidebar -->
<div id="sidebar"
    class="sidebar hidden fixed left-0 z-50 w-[250px] h-full rounded-r-lg bg-white shadow-xl overflow-y-auto">
