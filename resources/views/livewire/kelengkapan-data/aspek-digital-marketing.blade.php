<div>
    <x-sub-navbar href="javascript:history.back()">Aspek Digital Marketing</x-sub-navbar>
        ...
        <div class="flex flex-wrap justify-center w-full p-4">
            <div class="w-full grid grid-cols-1 gap-4 py-2 px-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div class="w-full flex flex-wrap justify-between items-center">
                    ...
                    <p class="w-full font-normal text-justify text-base text-slate-600">Seminggu Beberapa Kali</p>
                </div>

                <div class="w-full flex flex-wrap justify-between items-center">
                    <p class="w-full font-semibold text-justify text-sm">Pengelolaan <i>WhatsApp</i></p>
                    <p class="w-full font-normal text-justify text-base text-slate-600">Nomor untuk Bisnis Terpisah (Berbeda) dengan Akun Pribadi</p>
                </div>

                <div class="w-full flex flex-wrap justify-between items-center">
                    <p class="w-full font-semibold text-justify text-sm">Katalog di <i>WhatsApp Business</i></p>
                    <p class="w-full font-normal text-justify text-base text-slate-600">Tidak Memiliki Katalog</p>
                </div>

                <div class="w-full flex flex-wrap justify-between items-center">
                    <p class="w-full font-semibold text-justify text-sm">Penjawab Otomatis di <i>WhatsApp Business</i></p>
                    <p class="w-full font-normal text-justify text-base text-slate-600">Menerapkan di Ucapan Selamat Datang</p>
                </div>
                ...
                <div class="w-full flex flex-wrap justify-between items-center">
                    ...
                    <p class="w-full font-normal text-justify text-base text-slate-600">Setiap Hari Kerja</p>
                </div>
                ...
                <div class="w-full flex flex-wrap justify-between items-center">
                    <p class="w-full font-semibold text-justify text-sm">Respon pada Google Profil Bisnis</p>
                    <p class="w-full font-normal text-justify text-base text-slate-600">Jarang</p>
                </div>

                <div class="w-full flex flex-wrap justify-between items-center">
                    <p class="w-full font-semibold text-justify text-sm">Update Website/Blog</p>
                    <p class="w-full font-normal text-justify text-base text-slate-600">Cukup Jarang</p>
                </div>

                <div class="w-full flex flex-wrap justify-between items-center">
                    <p class="w-full font-semibold text-justify text-sm">
