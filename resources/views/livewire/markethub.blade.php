                    ...
                    <a wire:navigate:hover href="{{ route('detailProduk', ['id_produk' => 1]) }}"
                        ...
                        <div class="w-full flex flex-wrap">
                            <div class="w-fit mr-2">
                                <img src="{{ $valueBarang->gambar }}" alt="" class="w-20 h-20 rounded-md">
                            </div>
    ...
    <div data-dialog-backdrop="dialog" data-dialog-backdrop-close="true"
        ...
        <div data-dialog="dialog"
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            $("#jenis_produk").select2({
                                                ...
                                                let data = $(this).val();
                                                // console.log(data);
                                                // $wire.set('jenis_produk', data, false);
                                                $wire.jenis_produk = data;
                                                // @this.jenis_produk = data;
                                            });
                                        });
                                    </script>
                                @endscript
            ...
            <div class="flex shrink-0 flex-wrap items-center pt-4 justify-end">
                ...
                <button wire:click="jenisProduk" type="button" data-dialog-close="true" id="next" disabled
