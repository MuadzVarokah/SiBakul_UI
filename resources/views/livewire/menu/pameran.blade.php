<div>
    <x-sub-navbar href="javascript:history.back()">Pameran</x-sub-navbar>
    ...
    <div class="relative w-full max-w-screen-md mt-14 h-[calc(100vh-3.5rem)] bg-slate-100">
        <ul class="sticky top-14 flex flex-wrap p-4 pb-1.5 bg-slate-100 z-20" data-tabs="tabs" role="list">
            <li class="z-20 flex-auto text-center">
                <a class="z-20 flex items-center justify-center w-full px-0 py-2 text-sm mb-0 transition-all ease-in-out border-0 rounded-md cursor-pointer text-green-600 font-semibold bg-inherit"
                    data-tab-target="" role="tab" aria-selected="{{ $activeTab === 'tersedia' ? 'true' : 'false' }}"
                    aria-controls="tersedia">
                    Tersedia
                </a>
            </li>
            <li class="z-20 flex-auto text-center">
                <a class="z-20 flex items-center justify-center w-full px-0 py-2 mb-0 text-sm transition-all ease-in-out border-0 rounded-lg cursor-pointer text-green-600 font-semibold bg-inherit"
                    ...
                    aria-selected="{{ $activeTab === 'sedangDiikuti' ? 'true' : 'false' }}"
                    aria-controls="sedangDiikuti">
                    Sedang Diikuti
                </a>
            </li>
            <li class="z-20 flex-auto text-center">
                <a class="z-20 flex items-center justify-center w-full px-0 py-2 mb-0 text-sm transition-all ease-in-out border-0 rounded-lg cursor-pointer text-green-600 font-semibold bg-inherit"
                    data-tab-target="" role="tab" aria-selected="{{ $activeTab === 'riwayat' ? 'true' : 'false' }}"
        ...
        <div data-tab-content="">
            <div class="{{ $activeTab === 'tersedia' ? '' : 'hidden opacity-0' }}" id="tersedia" role="tabpanel">
                <div class="relative w-full">
                    ...
                    <div class="sticky top-[calc(3.5rem+58px)] w-full pb-4 pt-1.5 px-4 bg-slate-100">
                            ...
                            <form class="flex w-full">
                                <div class="relative w-full">
                                    <input type="search" id="search_tersedia"
                                        class="block px-2.5 py-2 w-full text-sm z-10 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-green-500"
                        ...
                        <div data-collapse="filter_tersedia"
                            class="block h-0 w-full basis-full overflow-hidden transition-all duration-300 ease-in-out">
                            <div class="flex flex-wrap justify-between mt-2">
                                <input type="date" name="tanggal_mulai_tersedia" id="tanggal_mulai_tersedia"
                                    autocomplete="on"
                                    class="block w-[45%] !bg-white placeholder:!text-slate-400 !text-sm !text-slate-700 !border !border-slate-200 !rounded-md !cursor-pointer !transition !duration-300 !ease focus:!outline-none focus:!border-slate-400 !shadow-sm focus:!shadow focus:!ring-0">
                                <span class="w-fit content-center"><i class="fa-solid fa-minus"></i></span>
                                <input type="date" name="tanggal_selesai_tersedia" id="tanggal_selesai_tersedia"
                                    autocomplete="on"
                                    class="block w-[45%] !bg-white placeholder:!text-slate-400 !text-sm !text-slate-700 !border !border-slate-200 !rounded-md !cursor-pointer !transition !duration-300 !ease focus:!outline-none focus:!border-slate-400 !shadow-sm focus:!shadow focus:!ring-0">
                            </div>
                        </div>
                    ...
                    <div class="w-full px-4 inline-block">
                        <!-- Daftar Pameran -->
                        @for ($i = 0; $i < 10; $i++)
                            <a wire:navigate href="{{ route('detailPameran', ['id_pameran' => 1]) }}"
                                ...
                                <div class="w-full flex flex-wrap">
                                    ...
                                    <div class="w-[calc(100%-4.5rem)] flex flex-col justify-between">
                                        ...
                                        <div class="w-full flex flex-wrap items-end">
                                            ...
                                            <p class="w-full text-xs text-slate-600 font-semibold">13 Apr 2024 - 15 Apr
                                                2024</p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="{{ $activeTab === 'sedangDiikuti' ? '' : 'hidden opacity-0' }}" id="sedangDiikuti"
                role="tabpanel">
                <div class="relative w-full">
                    <!-- Search & Filter -->
                    <div class="sticky top-[calc(3.5rem+58px)] w-full pb-4 pt-1.5 px-4 bg-slate-100">
                        <div class="flex items-center max-w-screen-md mx-auto">
                            ...
                            <form class="flex w-full">
                                <div class="relative w-full">
                                    <input type="search" id="search_sedangDiikuti"
                                        class="block px-2.5 py-2 w-full text-sm z-10 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-green-500"
                                        placeholder="Cari..." required />
                                    <button type="submit"
                                        class="absolute top-0 end-0 h-full px-2.5 py-2 text-sm font-medium text-white bg-green-700 rounded-e-lg border border-green-700 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                        ...
                        <div data-collapse="filter_sedangDiikuti"
                            class="block h-0 w-full basis-full overflow-hidden transition-all duration-300 ease-in-out">
                            <div class="flex flex-wrap justify-between mt-2">
                                <input type="date" name="tanggal_mulai_sedangDiikuti"
                                    id="tanggal_mulai_sedangDiikuti" autocomplete="on"
                                    class="block w-[45%] !bg-white placeholder:!text-slate-400 !text-sm !text-slate-700 !border !border-slate-200 !rounded-md !cursor-pointer !transition !duration-300 !ease focus:!outline-none focus:!border-slate-400 !shadow-sm focus:!shadow focus:!ring-0">
                                <span class="w-fit content-center"><i class="fa-solid fa-minus"></i></span>
                                <input type="date" name="tanggal_selesai_sedangDiikuti"
                                    id="tanggal_selesai_sedangDiikuti" autocomplete="on"
                                    class="block w-[45%] !bg-white placeholder:!text-slate-400 !text-sm !text-slate-700 !border !border-slate-200 !rounded-md !cursor-pointer !transition !duration-300 !ease focus:!outline-none focus:!border-slate-400 !shadow-sm focus:!shadow focus:!ring-0">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full px-4 inline-block">
                        <!-- Daftar Pameran -->
                        @for ($j = 0; $j < 10; $j++)
                            <a wire:navigate href="{{ route('detailPameran', ['id_pameran' => 2]) }}"
                                class="flex flex-wrap items-center justify-center w-full pl-2 pr-4 py-2 mb-4 text-sm border-0 rounded-md bg-white shadow">
                ...
                <div class="relative w-full">
                    ...
                    <div class="sticky top-[calc(3.5rem+58px)] w-full pb-4 pt-1.5 px-4 bg-slate-100">
                        <div class="flex items-center max-w-screen-md mx-auto">
                            ...
                            <form class="flex w-full">
                                <div class="relative w-full">
                                    <input type="search" id="search_riwayat"
                                        class="block px-2.5 py-2 w-full text-sm z-10 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-green-500"
                                        placeholder="Cari..." required />
                                    <button type="submit"
                                        class="absolute top-0 end-0 h-full px-2.5 py-2 text-sm font-medium text-white bg-green-700 rounded-e-lg border border-green-700 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                        ...
                        <div data-collapse="filter_riwayat"
                            class="block h-0 w-full basis-full overflow-hidden transition-all duration-300 ease-in-out">
                            <div class="flex flex-wrap justify-between mt-2">
                                <input type="date" name="tanggal_mulai_riwayat" id="tanggal_mulai_riwayat"
                                    autocomplete="on"
                                    class="block w-[45%] !bg-white placeholder:!text-slate-400 !text-sm !text-slate-700 !border !border-slate-200 !rounded-md !cursor-pointer !transition !duration-300 !ease focus:!outline-none focus:!border-slate-400 !shadow-sm focus:!shadow focus:!ring-0">
                                <span class="w-fit content-center"><i class="fa-solid fa-minus"></i></span>
                                <input type="date" name="tanggal_selesai_riwayat" id="tanggal_selesai_riwayat"
                                    autocomplete="on"
                                    class="block w-[45%] !bg-white placeholder:!text-slate-400 !text-sm !text-slate-700 !border !border-slate-200 !rounded-md !cursor-pointer !transition !duration-300 !ease focus:!outline-none focus:!border-slate-400 !shadow-sm focus:!shadow focus:!ring-0">
                            </div>
                        </div>
