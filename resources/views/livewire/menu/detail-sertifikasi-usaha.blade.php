<div>
    <x-sub-navbar href="javascript:history.back()">Detail Sertifikasi Usaha</x-sub-navbar>
    ...
    <div class="w-full max-w-screen-sm mt-14 min-h-[calc(100vh-3.5rem)] bg-slate-100">
        ...
        <div class="w-full p-4 grid grid-cols-1 gap-2 bg-white">
            <p class="text-2xl font-semibold text-green-600 leading-none">Sosialisasi dan Pembuatan NIB untuk UMKM</p>
            ...
            <div class="w-full flex flex-wrap justify-between items-center">
                ...
                <span class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">NIB</span>
            </div>
        ...
        <div class="w-full p-4 grid grid-cols-1 gap-2 bg-white">
            <div class="w-full flex flex-wrap justify-between items-center">
                ...
                <p class="w-fit font-normal text-justify text-base text-slate-600">17 Jan 2024</p>
            </div>
            ...
            <div class="w-full flex flex-wrap justify-between items-center">
                ...
                <p class="w-fit font-normal text-justify text-base text-slate-600">09:00 - 13:00</p>
            </div>
            ...
            <div class="w-full flex flex-wrap justify-between items-center">
                ...
                <p class="w-fit font-normal text-justify text-base text-slate-600">
                    Dinas Koperasi dan UKM - Jalan Ipsum No.69, Dolor, Sit Amet, Consectetur, Adipisicing.
                </p>
            </div>
        </div>
        ...
        <div class="w-full p-4 grid grid-cols-1 gap-2 bg-white">
            <div class="w-full flex flex-wrap justify-between items-center">
                ...
                <p class="w-fit font-normal text-justify text-base text-slate-600">Mas Robert</p>
            </div>
        ...
        <div class="w-full p-4 grid grid-cols-1 gap-2 bg-white">
            <div wire:ignore class="w-full flex flex-wrap justify-between items-center">
                <p class="w-fit font-semibold text-justify text-lg">Syarat Sertifikasi</p>
                ...
                @case(1)
                    <div class="flex items-center mt-4">
                        <div class="flex items-center h-5">
                            <input id="agree" type="checkbox" value="" onchange="document.getElementById('daftarSertifikasi').disabled = !this.checked;"
                        ...
                        <label for="agree" class="ms-2 font-medium text-gray-900 dark:text-gray-300">Saya siap mengikuti syarat sertifikasi</label>
                    </div>
        
                    <div class="relative mt-2">
                        <button id="daftarSertifikasi" type="button" disabled
                            ...
                            <i class="fa-solid fa-arrow-right-to-bracket"></i>&nbsp;&nbsp;Daftar Sertifikasi
                        </button>
                    </div>
                    @break
