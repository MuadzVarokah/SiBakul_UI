                            ...
                            <a wire:navigate href="{{ route('detailPelatihan', ['id_pelatihan' => 1]) }}"
                                ...
                                <div class="w-full flex flex-wrap">
                                    <div class="w-fit mr-2">
                                        {{-- <img src="https://via.placeholder.com/80" alt="" class="w-16 h-full min-h-16 max-h-[4.25rem] rounded-md"> --}}
                                        <div class="w-16 h-full min-h-16 max-h-[4.25rem] rounded-md text-4xl text-green-700 border border-green-700 text-center content-center">
            ...
            <div class="{{ $activeTab === 'sedangDiikuti' ? '' : 'hidden opacity-0' }}" id="sedangDiikuti" role="tabpanel">
                <div class="relative w-full">
                    ...
                    <div class="w-full px-4 inline-block">
                        <!-- Daftar Pelatihan -->
                        @for ($j = 0; $j < 10; $j++)
                            <a wire:navigate href="{{ route('detailPelatihan', ['id_pelatihan' => 2]) }}"
                                class="flex flex-wrap items-center justify-center w-full pl-2 pr-4 py-2 mb-4 text-sm border-0 rounded-md bg-white shadow">
            ...
            <div class="{{ $activeTab === 'riwayat' ? '' : 'hidden opacity-0' }}" id="riwayat" role="tabpanel">
                <div class="relative w-full">
                    ...
                    <div class="w-full px-4 inline-block">
                        <!-- Daftar Pelatihan -->
                        @for ($j = 0; $j < 10; $j++)
                            <a wire:navigate href="{{ route('detailPelatihan', ['id_pelatihan' => 3]) }}"
                                class="flex flex-wrap items-center justify-center w-full pl-2 pr-4 py-2 mb-4 text-sm border-0 rounded-md bg-white shadow">
