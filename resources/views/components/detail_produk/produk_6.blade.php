...
<!-- Section Tambahan - jenis 6 #1 -->
<div class="w-full p-4 grid grid-cols-1 gap-2 bg-white">
    <div class="w-full flex flex-wrap justify-between items-center">
        <p class="w-fit font-semibold text-justify text-lg">Saran Penggunaan</p>
...
<div class="w-full p-4 grid grid-cols-1 gap-2 bg-white">
    ...
    <div class="w-full flex flex-wrap justify-between items-center">
        <p class="w-fit font-semibold text-justify text-lg">Sertifikat BPOM</p>
        <a wire:navigate:hover href="#" class="w-fit font-normal text-justify text-base text-green-600">12345678901234</a>
    </div>
